...
export default function SettingsPage() {
  ...
  return (
    <MainLayout>
      ...
      <div className="card-metric max-w-xl space-y-6">
        <div className="flex items-center justify-between">
          <div><Label>Sync Automático</Label><p className="text-sm text-muted-foreground">Ativar sincronização automática</p></div>
